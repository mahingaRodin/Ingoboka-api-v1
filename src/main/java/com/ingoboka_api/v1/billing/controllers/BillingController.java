...
public class BillingController {
    ...
    @SecurityRequirement(name = "bearerAuth")
    public ApiResponse<List<PaymentResponse>> listMyPayments() {
        return ApiResponse.ok("Payments retrieved", billingService.listMyPayments());
    }
    ...
    @SecurityRequirement(name = "bearerAuth")
    public ApiResponse<List<PaymentResponse>> listPolicyPayments(@PathVariable UUID policyId) {
        return ApiResponse.ok("Payments retrieved", billingService.listPolicyPayments(policyId));
    }
}
